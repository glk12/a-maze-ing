...
from mazegen import MazeGenerator, load_config, solve_shortest_path, validate_maze
...
def main() -> int:
    ...
    coordinates, directions = solve_shortest_path(maze, config.entry, config.exit)
